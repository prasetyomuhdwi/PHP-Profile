        ...
        <div class="flex w-full justify-around">
          <div class="border-t border-gray-200">
            <dl>
              ...
              <div class="
                    ...
                    sm:grid sm:grid-cols-2 sm:gap-2 sm:px-4
                  ">
                <dt class="text-sm font-bold text-gray-500">Alamat</dt>
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
          ...
          <div class="border-t border-l border-gray-200">
            <dl class="flex flex-col items-center">
              <div class="bg-gray-50 px-2 py-5">
                <dt class="text-xs text-center font-bold text-gray-500">
                  Foto Profil
                </dt>
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
    ...
    <div id="modal" class="
      ...
      <div class="extraOutline p-4 bg-white w-max bg-whtie m-auto rounded-lg">
        <div class="
              ...
              rounded-lg
            " style="width: 450px">
          <svg class="chooseImg text-indigo-500 w-24 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
          </svg>
          <form class="input_field flex flex-col w-max mx-auto text-center" onsubmit="return onSubmit(event);" method="POST" enctype="multipart/form-data">
            <div class="chooseImg">
              <label>
                <input class="text-sm cursor-pointer w-36 hidden" type="file" name="profileImg" onChange="displayImage(this);" id="profileImg" multiple />
                <div class="
                      text
                      bg-indigo-400
                      text-white
            ...
            <div id="previewImg" class="hidden">
              <img src="./asset/default.png" id="profileDisplay" class="max-w-64 max-h-64" />
